...
class GameraConfigOptionParser(config.ConfigOptionParser):
    extra_files = []
...
config = config.GameraConfigOptionParser(usage="%prog [options] [script [script_args]]", version=__version__)
